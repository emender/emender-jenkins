...
(deftest test-throw-exception-existence
    "Check that the emender-jenkins.utils/throw-exception definition exists."
    (testing "if the emender-jenkins.utils/throw-exception definition exists."
        (is (callable? 'emender-jenkins.utils/throw-exception))))


(deftest test-parse-int-existence
    "Check that the emender-jenkins.utils/parse-int definition exists."
    (testing "if the emender-jenkins.utils/parse-int definition exists."
        (is (callable? 'emender-jenkins.utils/parse-int))))


(deftest test-parse-float-existence
    "Check that the emender-jenkins.utils/parse-float definition exists."
    (testing "if the emender-jenkins.utils/parse-float definition exists."
        (is (callable? 'emender-jenkins.utils/parse-float))))


(deftest test-parse-boolean-existence
    "Check that the emender-jenkins.utils/parse-boolean definition exists."
    (testing "if the emender-jenkins.utils/parse-boolean definition exists."
        (is (callable? 'emender-jenkins.utils/parse-boolean))))
...
(deftest test-starts-with-1
    "Check the function emender-jenkins.utils/starts-with."
    (testing "the function emender-jenkins.utils/starts-with."
        (are [x y] (= x y)
...
(deftest test-ends-with-1 "Check the function emender-jenkins.utils/ends-with."
    (testing "the function emender-jenkins.utils/ends-with."
        (are [x y] (= x y)
...
(deftest test-ends-with-2
    "Check the function emender-jenkins.utils/ends-with."
    (testing "the function emender-jenkins.utils/ends-with."
        (are [x y] (= x y)
...
(deftest test-throw-exception
    "Check the behaviour of function emender-jenkins.utils/throw-exception."
